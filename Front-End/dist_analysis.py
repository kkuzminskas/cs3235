...
def determine_thresholds(reference_files):
    ...
    training_neg_files = ["youkuan1.txt", "youkuan2.txt", "youkuan3.txt", "youkuan4.txt", "youkuan5.txt",
                          "k1.txt", "k2.txt", "k3.txt", "k4.txt", "k5.txt", "ahmed1.txt"]
    training_pos_files = ["data/siqi1.txt", "data/siqi2.txt", "data/siqi.txt"]
...
def main ():
    ...
    # test_files = [f"data/k{12+i}.txt" for i in range(9)] + [f"data/siqi{11 + i}.txt" for i in range(4)] + [f"data/wanching{2 + i}.txt" for i in range(4)]
