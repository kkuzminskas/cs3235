...
def try_distances(file1, file2, coord_type):
    ...
    # print("     x,y distance :" + str(x_y_distance))
...
def main():
    distances(["data/k1.txt", "data/k3.txt"], "data/youkuan1.txt", 'avg')
